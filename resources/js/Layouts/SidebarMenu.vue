        ...
        <a href="index3.html" class="brand-link bg-black border-b-4 border-gray-900">
            ...
            <div class="mt-2 pb-3 mb-2 d-flex justify-center items-center">
                <div class="rounded-full w-20 h-20 bg-white d-flex justify-center items-center p-3">
                    <img src="/dist/img/user.png" alt="User Image" class="object-cover">
                </div>
            </div>
            <div class="info text-center">
                <a href="#" class="d-block text-white hover:text-white font-normal text-md">{{
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
             ...
             with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <ResponsiveNavLink :href="route('filemanager')" :active="route().current('filemanager')">
                            <i class="nav-icon fas fa-file-code" aria-hidden="true"></i>
                            Arquivos
                        </ResponsiveNavLink>
                    </li>
                    <li class="nav-item">
                        <ResponsiveNavLink :href="route('manage')" :active="route().current('manage')">
                    ...
                    <li class="nav-item">
                        <ResponsiveNavLink href="http://panel.test:8020">
