...
import NavHeaderPortal from '@/Components/NavHeaderPortal.vue';
...
export default {
    ...
    methods: {
        ...
        favoriteHabbo(habbo) {
            axios.post(route('portal.habbos.favorite', { user_id: this.$page.props.auth.user.id, habbo_id: habbo })).then(response => {
...
<template>
    <NavHeaderPortal />
    <section class="h-full box-border flex justify-center pt-5 bg-gray-100">

        <div class="w-8/12">

            <div class="slider mb-10">
                <div class="bg-black relative rounded-2xl">
                    <img src="https://miro.medium.com/max/1400/1*jIpenyYzSAwLD-aOTSzaLA.png" class="object-fill">
                    <div class="text-white bg-black p-2 relative rounded-2xl">
                        <p class="font-bold text-2xl text-white opacity-100">
                            Encontre um Hotel e começe a Jogar!
                        </p>
                        <p class="font-bold">BlackHabbos chegou!</p>
                    </div>
                </div>
            </div>

            <div class="slider mb-4">
                <div class="bg-black relative rounded-3xl border-b-4 border-gray-600">
                    <div class="text-white bg-black p-4 relative rounded-2xl">
                        <p class="font-bold text-md text-white opacity-100">
                            A BlackHabbos é uma plataforma que visa reunir os melhores Habbos do Brasil em um só lugar.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="chat mt-5 mb-40">
                <div class="card">
                    <div class="flex justify-between items-center p-3">
                        <h3 class="text-2xl font-bold">Faça amizades em nosso chat </h3>
                ...
                <div class="" v-if="tabListHabbo == 0">
                    <div class="card shadow-md"
                        ...
                        <div class="card-body flex justify-start items-center" id="boosts">
                            <div class="w-2/12">
                                <div
                                    class="bg-white/50 rounded-full w-36 h-36 flex justify-center items-center relative">
                            ...
                            <div class="w-4/12 flex justify-center items-center">
                                ...
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    <a :href="habbo.domain" target="_blank"
                                        class="bg-black text-white font-bold px-4 py-2 rounded-full">Entrar</a>
                                    ...
                                    <p class="text-center ml-3 flex justify-center gap-1 hover:cursor-pointer hover:text-gray-700 hover:fill-gray-700"
                                        ...
                                        <svg class="h-5 w-5" version="1.1" id="Capa_1"
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                            viewBox="0 0 525.153 525.153"
                                            style="enable-background:new 0 0 525.153 525.153;" xml:space="preserve">
                                            <g>
    ...
    <footer class="bg-black py-8 flex justify-center">
        <p>@ BlackHabbos 2022 | Developer: LuanSP12</p>
    </footer>
</template>